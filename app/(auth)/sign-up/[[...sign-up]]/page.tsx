        ...
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-purple-600 via-indigo-600 to-purple-800 px-4">
            <div className="w-full max-w-md rounded-2xl bg-white/90 shadow-xl p-8 backdrop-blur-md dark:bg-zinc-900">
                ...
                <h2 className="text-2xl font-bold text-center text-purple-700 dark:text-purple-300">
                    Создать аккаунт в <span className="text-indigo-600">AI-Career</span>
                </h2>
                ...
                <p className="mt-4 text-center text-sm text-gray-500">
                    Уже есть аккаунт? <Link href="/sign-in" className="text-purple-600 hover:underline">Войти</Link>
                </p>
