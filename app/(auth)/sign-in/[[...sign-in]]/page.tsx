...
function SignIn() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-purple-600 via-indigo-600 to-purple-800 px-4">
            <div className="w-full max-w-md rounded-2xl bg-white/90 shadow-xl p-8 backdrop-blur-md dark:bg-zinc-900">
                ...
                <h2 className="text-2xl font-bold text-center text-purple-700 dark:text-purple-300">
                    Добро пожаловать в <span className="text-indigo-600">AI-Career</span>
                </h2>
                ...
                <form className="mt-6 space-y-4" onSubmit={handleLogin}>
                    ...
                    <button
                        className="relative flex h-10 w-full items-center justify-center rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-medium shadow-md transition hover:opacity-90"
                        type="submit"
                    >
                ...
                <p className="mt-4 text-center text-sm text-gray-500">
                    Нет аккаунта? <Link href="/sign-up" className="text-purple-600 hover:underline">Зарегистрироваться</Link>
                </p>
